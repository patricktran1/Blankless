...
export function EscalationBanner() {
  ...
  return <div role="alert" className="mt-5 flex w-full items-center gap-3 rounded-2xl border border-canceled/30 bg-canceled/10 px-4 py-3 text-sm font-semibold text-canceled shadow-sm">
