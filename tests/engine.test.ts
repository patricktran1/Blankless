...
describe("Blankless deterministic engine", () => {
  ...
  it("changes Scenario 2 behavior", () => {
    ...
    const eligible = guardCandidates(patients, slot, 125, ["pt-01"], 2).eligible;
